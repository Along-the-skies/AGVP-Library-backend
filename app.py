...
questions = [
    ...
    {"question": "ജി. ശങ്കരക്കുറുപ്പ്ബേപ്പൂർ, മാങ്കോസ്റ്റീന്‍ മരം, തലയോലപ്പറമ്പ്, ശിങ്കിടിമുങ്കന്‍  ഈ വാക്കുകളെല്ലാം ഒരു വ്യക്തിയിലേക്ക് വിരല്‍ ചൂണ്ടുന്നു. ആരാണ് ഈ വ്യക്തി.  ലളിതമായ ഭാഷയിൽ സാധാരണക്കാരുടെ ജീവിതം പറഞ്ഞ ഇദ്ദേഹം ഒരു നിശ്ചിത കാലം ജയിലിലും കഴിഞ്ഞിട്ടുണ്ട്.", "choices": ["എസ്.കെ പൊറ്റെക്കാട്","മാധവിക്കുട്ടി","വൈക്കം മുഹമ്മദ് ബഷീര്‍","എം.ടി വാസുദേവന്‍ നായര്‍"], "answer": "C"},
